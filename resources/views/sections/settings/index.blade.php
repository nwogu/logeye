...
@section('content')
    <div class="grid">
        <div class="cell cell-6-8--dlg-i cell-5-8--mmd-i">
            <form-builder url="{{ route('settings.refresh.api.token') }}" :default='@json($user)'
                send-text="Refresh API Token">
                <fb-input name="_token" label="{{ _p('pages.settings.form.user._token', 'API Token') }}"></fb-input>
            </form-builder>
